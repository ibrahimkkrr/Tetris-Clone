#include "Jblock.h"
 ...
 bool Jblock::isSpawned = false;

 std::array<sf::RectangleShape, 4> Jblock::shapes;
 std::array<sf::Vector2f, 4> Jblock::shapesPostions;
...
Jblock::Jblock()
{
	...
	blockTextur.loadFromFile("orange.png");
...
void Jblock::draw(sf::RenderWindow* window)
{
...
int Jblock::randomDirectionSpawn()
{
...
int Jblock::getColorNumber()
{
	return colorNumber;

}

std::array<sf::RectangleShape, 4>& Jblock::getShapes()
{
	return shapes;
}

std::array<sf::Vector2f, 4>& Jblock::getShapesPostions()
{
	return shapesPostions;
}

int Jblock::getDirection()
{
	return direction;
}

bool Jblock::getSpawnState()
{
	return isSpawned;
}

void Jblock::setSpawnState(bool spawn)
{ 
	isSpawned = spawn;
}


void Jblock::setupShapeSize()
{
	for (int i = 0; i < shapes.size(); i++)
...
void Jblock::setupShapesTexture()
{
	for (int i = 0; i < shapes.size(); i++)
...
void Jblock::setupShapesGlobalBounds()
{
...
int Jblock::check_block_limite_left()
{
	switch (direction)
	{
	case 1:
...
void Jblock::updateBlock1Postion()
{
	if (direction == north)
	{
...
void Jblock::updateBlock2Postion()
{
	if (direction == north)
	{
...
void Jblock::updateBlock3Postion()
{
	if (direction == south)
	{
...
void Jblock::updateBlock4Postion()
{
	if (direction == north)
	{
